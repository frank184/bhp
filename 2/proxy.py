...
def proxy_handler(client_socket, remote_host, remote_port, receive_first):
    ...
    # now lets loop and read from local, send to remote, send to local, rinse&repeat
    while True:
...
def receive_from(connection):
    ...
    # we set a 2 sec timeout; depending on your target, this may need to be adjusted
